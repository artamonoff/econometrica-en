...
For the dataset \texttt{diamonds} consider a regression
\begin{center}
	\texttt{cut on log(price), log\textsuperscript{2}(price), carat, carat\textsuperscript{2}}.
\end{center}
\begin{enumerate}
	\item Fit the regression
	\item For each coefficient evaluate s.e., z-stat \& p-value for z-test on the significance 
...
\begin{center}
	...
	\end{tabular}
\end{center}
Predict the dependent variable for each individual in the sample and interpret predicted values. 
